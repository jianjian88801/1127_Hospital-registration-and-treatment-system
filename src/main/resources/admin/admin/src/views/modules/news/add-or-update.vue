    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公告名称" prop="newsName">
                       <el-input v-model="ruleForm.newsName"
                                 placeholder="公告名称" clearable  :readonly="ro.newsName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="公告名称" prop="newsName">
                           <el-input v-model="ruleForm.newsName"
