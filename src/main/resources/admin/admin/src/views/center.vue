  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yisheng'"  label='挂号须知' prop="yishengGuahao">
               <el-input v-model="ruleForm.yishengGuahao"  placeholder='挂号须知' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yisheng'"  label='挂号价格' prop="yishengNewMoney">
                 <el-input v-model="ruleForm.yishengNewMoney"  placeholder='挂号价格' disabled ></el-input>
             </el-form-item>
         </el-col>
         <el-col :span="24">
