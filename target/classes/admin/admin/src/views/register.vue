<template>
    <div style="backgroundImage: url('/yiyuanguanhaojiuzhen/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">医院挂号就诊系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="医生名称" class="input" v-if="tableName=='yisheng'">
                            <el-input v-model="ruleForm.yishengName" autocomplete="off" placeholder="医生名称"  />
                        </el-form-item>
